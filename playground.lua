...
pat = require 'board.pattern_v2'
board = require 'board.board'
common = require 'common.common'
goutils = require 'utils.goutils'
...
opt = {pattern_file="./models/playout-policy.bin",verbose=-1,sample_topn=-1,temperature=0.5,sgf_file='./sgfs/alphago_leesedol_1.sgf',move_from=0,num_moves=100,num_games=10}
